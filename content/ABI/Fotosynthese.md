...
Die Fotosynthesegleichung lautet:
$$6 CO_2 + 12H_2O \Rightarrow C_6H_{12}O_6 + 6H_2O + 6 O_2$$

Der Stoffwechselvorgang der Fotosynthese ist nur durch die spezifische Struktur des Chloroplasten -der Zellorganelle, welche das Chlorophyl beinhaltet, und in welcher die Fotosynthese stadtfindet- (Thylakoidinnenraum, Stroma und Intermembranraum). Nur mit der Kompartimentierung des Chloroplast in verschiedene Reaktionsräume ist es möglich die oft nahezu gegenläufigen reaktionen der Fotosynthese unter vielen verschiedenen Bedingugen möglich zu machen.

In der Thylakoidmembran absorbieren Chlorophyl a & b Licht , vor allem im Roten & Blauen Spektralbereich, Und Carotinoide geben die energie des von ihnen absorbierten lichtes and Chlorophyl weiter.
Die Absorbationsspektren dieser Blattfarbsstoffe stimmt größtenteils mit dem Wirkungsspektrum der Fotosynthese überein.

# Ablauf

## Fotoreaktionen (Primärvorgang):
